...
# get the fitted transformer and fitted decision tree from the best pipeline
best_transformer = best_model_rojina.named_steps["transformer"]
best_tree = best_model_rojina.named_steps["model"]

# get feature names after one hot encoding
feature_names_rojina = best_transformer.get_feature_names_out()

# class names for pass/fail
class_names_rojina = ["fail", "pass"]

# export tree to dot format
dot_data = export_graphviz(
    best_tree,
    out_file=None,
    feature_names=feature_names_rojina,
    class_names=class_names_rojina,
    filled=True,
    rounded=True,
...
# save as png
graph.format = "png"
graph.render("decision_tree_rojina", cleanup=True)

print("tree saved as decision_tree_rojina.png")